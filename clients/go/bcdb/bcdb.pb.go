...
type Metadata struct {
	...
	// an associated piece of text that can
	// be used later with full text search
	// to find the object back
	Collection string `protobuf:"bytes,2,opt,name=collection,proto3" json:"collection,omitempty"`
	// acl is a ref to the acl key
	Acl                  uint64   `protobuf:"varint,3,opt,name=acl,proto3" json:"acl,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_41b705b2a83eae7f = []byte{
	...
	,
}
