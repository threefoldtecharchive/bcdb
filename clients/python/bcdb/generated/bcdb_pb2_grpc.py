...
class BCDBStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Head = channel.unary_unary(
        '/bcdb.BCDB/Head',
        request_serializer=bcdb__pb2.GetRequest.SerializeToString,
        response_deserializer=bcdb__pb2.HeadResponse.FromString,
        )
    self.Fetch = channel.unary_unary(
        '/bcdb.BCDB/Fetch',
        request_serializer=bcdb__pb2.FetchRequest.SerializeToString,
        response_deserializer=bcdb__pb2.GetResponse.FromString,
        )
...
def add_BCDBServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'Head': grpc.unary_unary_rpc_method_handler(
          servicer.Head,
          request_deserializer=bcdb__pb2.GetRequest.FromString,
          response_serializer=bcdb__pb2.HeadResponse.SerializeToString,
      ),
      'Fetch': grpc.unary_unary_rpc_method_handler(
          servicer.Fetch,
          request_deserializer=bcdb__pb2.FetchRequest.FromString,
          response_serializer=bcdb__pb2.GetResponse.SerializeToString,
      ),
