...
class BCDB(object):
    ...
    def Set(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bcdb.BCDB/Set',
            bcdb__pb2.SetRequest.SerializeToString,
            bcdb__pb2.SetResponse.FromString,
    ...
    def Get(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bcdb.BCDB/Get',
            bcdb__pb2.GetRequest.SerializeToString,
            bcdb__pb2.GetResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Update(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bcdb.BCDB/Update',
            bcdb__pb2.UpdateRequest.SerializeToString,
            bcdb__pb2.UpdateResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def List(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/bcdb.BCDB/List',
            bcdb__pb2.QueryRequest.SerializeToString,
            bcdb__pb2.ListResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Find(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/bcdb.BCDB/Find',
            bcdb__pb2.QueryRequest.SerializeToString,
            bcdb__pb2.FindResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
