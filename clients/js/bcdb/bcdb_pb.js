...
goog.exportSymbol('proto.bcdb.HeadResponse', null, global);
 ...
 * @constructor
 */
proto.bcdb.HeadResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bcdb.HeadResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bcdb.HeadResponse.displayName = 'proto.bcdb.HeadResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.bcdb.HeadResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.bcdb.HeadResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bcdb.HeadResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bcdb.HeadResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    metadata: (f = msg.getMetadata()) && proto.bcdb.Metadata.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.bcdb.HeadResponse}
 */
proto.bcdb.HeadResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bcdb.HeadResponse;
  return proto.bcdb.HeadResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bcdb.HeadResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bcdb.HeadResponse}
 */
proto.bcdb.HeadResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bcdb.HeadResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bcdb.HeadResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bcdb.HeadResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bcdb.HeadResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getMetadata();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.bcdb.Metadata}
 */
proto.bcdb.HeadResponse.prototype.getMetadata = function() {
  return /** @type{?proto.bcdb.Metadata} */ (
    jspb.Message.getWrapperField(this, proto.bcdb.Metadata, 1));
};
...
/**
 * @param {?proto.bcdb.Metadata|undefined} value
 * @return {!proto.bcdb.HeadResponse} returns this
*/
proto.bcdb.HeadResponse.prototype.setMetadata = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.bcdb.HeadResponse} returns this
 */
proto.bcdb.HeadResponse.prototype.clearMetadata = function() {
  return this.setMetadata(undefined);
};
 ...
 * @return {boolean}
 */
proto.bcdb.HeadResponse.prototype.hasMetadata = function() {
  return jspb.Message.getField(this, 1) != null;
};
